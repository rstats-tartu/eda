...
It's simple, we have already summary data available in our table variable called "All malignant neoplasms (C00-C97)" in Site column.
...
## we disect plot to an object, then we can reuse it
...
We can see that the number of new cases has increased `r sprintf("%1.0f%%", round(diff(cases_range)/cases_range[1], 2)*100)` since year 2000, from `r paste(range(total_cases_per_year$total_cases), collapse = " to ")`.
