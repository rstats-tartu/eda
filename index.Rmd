...
First we download "tidyverse" library. We are going to need also "stringr" library for string manipulation:
```{r, message=FALSE}
library(tidyverse)
library(stringi)
library(stringr)
...
Summary data contain tallies from range of **ICD10** codes e.g. "(C00-C97)".
We probably need ICD10 codes to **identify and label summary data** so that we can decide later what we do with these rows. 
