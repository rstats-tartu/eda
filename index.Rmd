...
This table has data intermingled with summary data -- incidence of specific cancer types are next to total incidence -- , that's bad! 
```
Year  Site                              Sex
<fctr><fctr>                            <fctr>
...
Summaries are provided for different range of **ICD10** codes e.g. "(C00-C97)", covering all types of cancer.
...
- Label says what the values are, 
